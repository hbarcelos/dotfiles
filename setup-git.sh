...
ensure_identity_file \
  ...
  "$REPO_DIR/.gitconfig.d/personal-identity.gitconfig.template" \
  "false" \
...
ensure_identity_file \
  ...
  "$REPO_DIR/.gitconfig.d/work-identity.gitconfig.template" \
  "true" \
...
write_work_urls_file \
  ...
  "$REPO_DIR/.gitconfig.d/work-urls.gitconfig.template"
